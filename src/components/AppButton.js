...
export default function AppButton({ onPress, title, icon, color = colors.primary, outline = false, style }) {
  return (
    <TouchableOpacity 
      ...
      style={[
        styles.button, 
        outline ? { borderWidth: 1, borderColor: color, backgroundColor: 'transparent' } : { backgroundColor: color, shadowColor: color, shadowOpacity: 0.35, shadowRadius: 10, elevation: 4 },
        style
      ]}
    >
